...
@section('content')
  <div class="card">
    ...
    <div class="card-body">
      <form method="POST" action="{{route('process.user.profile')}}">
        @csrf
        <div class="row">
            <div class="col-md-6">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form method="POST" action="{{route('process.user.password')}}">
        @csrf
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input 
                    name="password" type="password" class="form-control" id="password" placeholder="Kata Sandi">
                </div>
            </div>
            <div class="col">
              <div class="form-group">
                  ...
                  <input 
                  name="password_confirmation" type="password" class="form-control" id="password_confirmation" placeholder="Konfirmasi Kata Sandi">
              </div>
          </div>
        </div>
